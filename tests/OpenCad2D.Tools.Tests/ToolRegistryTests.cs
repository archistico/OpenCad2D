...
public sealed class ToolRegistryTests
{
    ...
    public void Constructor_ShouldRegisterDefaultTools()
    {
        ...
        Assert.True(registry.Contains(ToolId.BoundaryFill));
    ...
    public void Tools_ShouldReturnAllRegisteredDescriptors()
    {
        ...
        Assert.Contains(
            tools,
            descriptor => descriptor.Id == ToolId.Divide);
        ...
        Assert.Contains(
            tools,
            descriptor => descriptor.Id == ToolId.Offset);

        Assert.Contains(
            tools,
            descriptor => descriptor.Id == ToolId.BoundaryFill);
        ...
        Assert.Contains(
            tools,
            descriptor => descriptor.Id == ToolId.Stair);
    ...
    public void GetByCategory_Modify_ShouldReturnModifyTools()
    {
        ...
        Assert.Contains(tools, descriptor => descriptor.Id == ToolId.BoundaryFill);
    ...
    [Fact]
    public void Create_Stair_ShouldReturnStairTool()
    {
        var registry = new ToolRegistry();

        ICadTool tool = registry.Create(ToolId.Stair);
    ...
    [Fact]
    public void Create_Offset_ShouldReturnOffsetTool()
    {
        var registry = new ToolRegistry();

        ICadTool tool = registry.Create(ToolId.Offset);

        Assert.IsType<OffsetTool>(tool);
        Assert.Equal("Offset", tool.Name);
    }

    [Fact]
    public void Create_Fillet_ShouldReturnFilletTool()
    {
        var registry = new ToolRegistry();

        ICadTool tool = registry.Create(ToolId.Fillet);
    ...
    [Fact]
    public void Create_BoundaryFill_ShouldReturnBoundaryFillTool()
    {
        var registry = new ToolRegistry();

        ICadTool tool = registry.Create(ToolId.BoundaryFill);

        Assert.IsType<BoundaryFillTool>(tool);
    ...
    public void GetByCategory_ShouldBeCaseInsensitive()
    {
        ...
        Assert.Contains(tools, descriptor => descriptor.Id == ToolId.Divide);
