...
The current source of truth is [roadmap.md](roadmap.md), with the detailed v0.8.100+ continuation in [roadmap-v0.8.100.md](roadmap-v0.8.100.md). The 2026-06-21 reconciliation added specifications for the next planned feature families: [Blocks v2](specs/v0.8.170-blocks-v2.md), [Shared Anchor Foundation](specs/v0.8.180A-shared-anchor-foundation.md), [HUD Anchor Selector Foundation](specs/v0.8.180B-hud-anchor-selector-foundation.md), [Minimal DoorEntity](specs/v0.8.180C-minimal-door-entity.md), [Door Wall-Mask Foundation](specs/v0.8.180D-door-wall-mask-foundation.md), [Minimal WindowEntity](specs/v0.8.180E-minimal-window-entity.md), [Door/Window Editing Defaults](specs/v0.8.180F-door-window-property-editing-defaults.md), [Door/Window HUD Status Closeout](specs/v0.8.180G-door-window-hud-status-closeout.md), [Door/Window Phase Closeout](specs/v0.8.180H-door-window-phase-closeout.md), [Parametric Doors and Windows](specs/v0.8.180-parametric-doors-windows.md), [Array Tools](specs/v0.8.190-array-tools.md), [Hatch Patterns](specs/v0.8.200-hatch-patterns.md), [Annotation Markers](specs/v0.8.210-annotation-markers.md), [UI Customization](specs/v0.8.220-ui-customization.md), and [Icon SVG Workflow](specs/v0.8.230-icon-svg-workflow.md). The planning specification pass also added shared contracts for the [9-point anchor system](specs/shared-anchor-system.md), [leader and arrowhead system](specs/shared-leader-arrow-system.md), [preview/commit/grouped undo workflow](specs/shared-preview-and-commit-workflow.md), and [wall mask/opening behavior](specs/shared-wall-mask-openings.md).

Manual verification notes are stored under `docs/testing/`. They are not a replacement for automated tests, but they are useful for validating workflows that depend on visual behavior, snapping, the Dynamic HUD, or user interaction. Boundary Fill v2 has a dedicated [manual checklist](testing/boundary-fill-v2-manual-checklist.md) because its preview/confirm, gap-tolerance and curve-sampling behavior is partly visual. Blocks v2 slice 170A has a dedicated [manual checklist](testing/v0.8.170A-block-manager-inventory-diagnostics-checklist.md) for reference-count and diagnostic behavior, slice 170B has a dedicated [manual checklist](testing/v0.8.170B-block-manager-duplicate-purge-checklist.md) for duplicate/delete/purge behavior, slice 170C has a dedicated [manual checklist](testing/v0.8.170C-block-edit-session-hardening-checklist.md) for in-place edit-session safety, slice 170D has a dedicated [manual checklist](testing/v0.8.170D-library-block-conflict-policy-checklist.md) for Library/block conflict handling, and slice 170E has a dedicated [manual checklist](testing/v0.8.170E-block-manager-rename-closeout-checklist.md) for rename closeout. For technical reading order, use [Technical Documentation Map](developer/technical-documentation-map.md).
...
The v0.8.170A Block Manager checklist is stored in `docs/testing/v0.8.170A-block-manager-inventory-diagnostics-checklist.md`; the v0.8.170B duplicate/purge checklist is stored in `docs/testing/v0.8.170B-block-manager-duplicate-purge-checklist.md`; the v0.8.170C edit-session checklist is stored in `docs/testing/v0.8.170C-block-edit-session-hardening-checklist.md`; the v0.8.170D Library/block conflict checklist is stored in `docs/testing/v0.8.170D-library-block-conflict-policy-checklist.md`; the v0.8.170E rename closeout checklist is stored in `docs/testing/v0.8.170E-block-manager-rename-closeout-checklist.md`; the broader v0.8.162 manual compatibility checklist remains in `docs/testing/v0.8.162-compatibility-smoke-checklist.md`, with a reusable report template in `docs/testing/v0.8.162-compatibility-smoke-report-template.md`.
...
- `docs/testing/v0.8.180D-door-wall-mask-foundation-checklist.md` — Manual smoke checklist for door masks, Property Panel toggle and export behavior.
...
- `docs/specs/v0.8.180G-door-window-hud-status-closeout.md` — door/window HUD prompt state for anchor, mask and door swing before insertion.
