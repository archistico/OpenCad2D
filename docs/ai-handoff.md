...
| v0.8.130 | [~] | `docs/specs/v0.8.130-stairs.md` | Stair work has started with the parametric core model, generated linework, renderer integration, snap/selection support, JSON persistence and SVG/PDF/DXF linework export; property editing and the insertion tool remain open. |
