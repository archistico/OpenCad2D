...
| v0.8.145 | [~] | `docs/specs/v0.8.145-boundary-fill-v2.md` | Boundary Fill v2 audit/specification prepared: preview, sampled arc/circle boundaries, explicit gap tolerance, diagnostics and filled-polyline output before HatchEntity. |
