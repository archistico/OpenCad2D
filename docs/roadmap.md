...
| v0.8.130 | [~] | `docs/specs/v0.8.130-stairs.md` | Stair work has started with the parametric core model, generated linework, renderer integration, snap/selection support, JSON persistence, SVG/PDF/DXF linework export and Property Panel editing; the insertion tool remains open. |
