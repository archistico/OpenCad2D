...
| v0.8.130 | [~] | `docs/specs/v0.8.130-stairs.md` | Stair work has started with the parametric core model, generated linework, renderer integration and snap/selection support; persistence, property editing, insertion tool and export integration remain open. |
