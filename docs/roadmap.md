...
| v0.8.130 | [~] | `docs/specs/v0.8.130-stairs.md` | Stair work has started with the parametric core model and generated linework; rendering, persistence, property editing, insertion tool and export integration remain open. |
