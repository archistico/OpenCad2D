...
| v0.8.145 | [x] | `docs/specs/v0.8.145-boundary-fill-v2.md` | Boundary Fill v2 preview/confirm workflow is implemented with result diagnostics, segment collector, sampled curve boundaries, endpoint gap-tolerance clustering, editable Gap option and ignored-entity diagnostics. |
