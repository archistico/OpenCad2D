...
/// <summary>
/// Generated linework for a schematic parametric door.
/// </summary>
public sealed class DoorGeometry
{
    public DoorGeometry(
    ...
    /// <summary>
    /// Optional non-destructive wipeout polygon for hiding wall linework under the door opening.
    /// </summary>
