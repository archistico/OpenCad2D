...
/// <summary>
/// Interactive tool used to insert multiline text entities.
/// </summary>
public sealed class MultilineTextTool : IAsyncCadTool, ICommandDrivenTool
{
    private readonly ITextInputProvider _textInputProvider;

    public MultilineTextTool(ITextInputProvider? textInputProvider = null)
    {
    ...
    private static TextInputRequest CreateTextInputRequest(
        ToolContext context,
        ...
        TextInputResult? input)
    {
        ...
        {
            return ToolResult.Cancelled("Multiline text cancelled.");
        }
        ...
        return ToolResult.Completed("Multiline text created.");
    }
