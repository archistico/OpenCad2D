...
The current line includes v0.8.180G. Door and window entities now share the 9-point HUD anchor selector, non-destructive wall-mask behavior, editable Property Panel parameters, per-command insertion defaults for their core dimensions and explicit HUD prompt state for anchor/mask/swing before insertion.
